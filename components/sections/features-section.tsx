        ...
        <div className="mt-4 grid grid-cols-1  md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="flex flex-col items-center p-4 bg-transparent text-card-foreground rounded-xl border shadow-sm hover:scale-105 hover:shadow-xl transition-all duration-300"
              >
