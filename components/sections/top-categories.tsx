      ...
      {isLoading ? (
        ...
        <div className="relative mt-8">
          <Carousel className="w-full" plugins={[plugin.current]}>
            <CarouselContent className="grid grid-flow-col auto-cols-[calc(50%-0.5rem)] sm:auto-cols-[calc(25%-0.75rem)] lg:auto-cols-[calc(12.5%-1rem)] gap-4 px-4 sm:px-8 py-2 lg:justify-center">
